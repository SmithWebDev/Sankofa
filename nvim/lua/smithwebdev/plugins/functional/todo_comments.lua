...
vim.keymap.set('n', ']c',          require('todo-comments').jump_next,          {desc = 'Next Todo Comment',                     silent = true })
vim.keymap.set('n', '[c',          require('todo-comments').jump_prev,          {desc = 'Previous Todo Comment',                 silent = true })
