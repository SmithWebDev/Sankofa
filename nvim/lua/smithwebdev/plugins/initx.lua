...
--     config = function ()
--       require'smithwebdev.plugins.cosmetics.dressing'
--     end
--   }
-- )
--
...
--
-- SankofaPlugins.add(
--   'https://github.com/nvim-/nvim-treesitter',{
--     dependencies = SankofaPlugins.deps_from_urls({
--       'https://github.com/OXY2DEV/markview.nvim',
--       'https://github.com/nvim-/playground',
--       'https://github.com/RRethy/nvim--endwise',
--       'https://github.com/nvim-/nvim-treesitter-textobjects',
--       'https://github.com/RRethy/nvim--textsubjects',
--     }),
--     config = function()
--       require'smithwebdev.plugins.functional.'
--     end
--   }
-- )
--
