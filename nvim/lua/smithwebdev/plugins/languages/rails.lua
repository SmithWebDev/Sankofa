print("rails keybinds available")
...
vim.keymap.set("n", "<leader><leader>rbo",    ":!bundle outdated<CR>",                            { desc = "Bundle Update Command",                         silent = true })
...
vim.keymap.set("n", "<leader><leader>rat",    "<cmd>AT<CR>",                                      { desc = "edit alternate in tab",                         silent = true })
vim.keymap.set("n", "<leader><leader>rav",    "<cmd>AV<CR>",                                      { desc = "edit alternate in v split",                     silent = true })
...
vim.keymap.set("n", "<leader><leader>ret",    "<cmd>RT<CR>",                                      { desc = "edit relative in tab",                          silent = true })
vim.keymap.set("n", "<leader><leader>rev",    "<cmd>RV<CR>",                                      { desc = "edit relative in v split",                      silent = true })
